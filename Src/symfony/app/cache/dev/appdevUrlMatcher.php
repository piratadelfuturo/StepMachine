...
class appdevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (rtrim($pathinfo, '/') === '') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'BoomFrontBundle_homepage');
            }

            return array (  '_controller' => 'Boom\\Bundle\\FrontBundle\\Controller\\DefaultController::indexAction',  '_route' => 'BoomFrontBundle_homepage',);
        }
