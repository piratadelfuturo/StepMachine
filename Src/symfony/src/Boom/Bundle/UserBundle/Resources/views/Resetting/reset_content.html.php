...
<div class="pass-page">
  ...
  <form action="<?php echo $view['router']->generate('fos_user_resetting_reset',array('token' => $token)); ?>"
      ...
      <div class="grad-border">
        <?php echo $view['form']->widget($form['plainPassword']['first'], array('attr' => array( 'class' => 'cp-new', 'placeholder' => 'Introduce tu nueva contraseña...' ) )); ?>
      </div>
      <div class="grad-border">
        <?php echo $view['form']->widget($form['plainPassword']['second'], array('attr' => array( 'class' => 'cp-confirm', 'placeholder' => 'Una vez más, para estar seguros...' ) )); ?>
      </div>
      <div class="sub-btn">
