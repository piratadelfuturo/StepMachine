...
<html xmlns:fb="http://ogp.me/ns/fb#" xmlns:og="http://opengraphprotocol.org/schema/">
    <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# seven_boom_mx: http://ogp.me/ns/fb/seven_boom_mx#">
        <?php
        $fb_boom_graph_data = $view['slots']->get('fb_boom_graph_data', null);
        if ($fb_boom_graph_data !== null):
            ?>
        ...
        <link rel="alternate" type="application/rss+xml" title="RSS" href="<?php echo $view['router']->generate('BoomFrontBundle_list_latest_feed', array(), true); ?>" />
