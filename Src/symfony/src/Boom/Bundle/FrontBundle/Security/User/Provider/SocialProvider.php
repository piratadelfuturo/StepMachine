...
class SocialProvider implements UserProviderInterface {
    ...
    public function __construct(BaseFacebook $facebook, TwitterOAuth $twitter_oauth, $userManager, $validator) {
