...
class BoomController extends Controller {
    ...
    public function categoryAction($slug = 'todas') {

        return $this->render(
                        'BoomFrontBundle:Boom:category.html.php', array(
                    'title' => $slug
                        )
        );
    }
    ...
    public function homeBlockAction($title = 'boom') {
        ...
        return $this->render(
                        'BoomFrontBundle:Boom:home/block.html.php', array(
                    'title' => $title
                        )
        );
    }
    ...
    public function longBlockAction() {
        ...
        return $this->render(
                        'BoomFrontBundle:Boom:home/long.html.php', array(
                    'title' => $title
                        )
        );
    }
