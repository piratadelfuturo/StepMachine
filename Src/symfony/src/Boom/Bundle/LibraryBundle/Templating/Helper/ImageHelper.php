...
class ImageHelper extends Helper {
    ...
    public function getBoomImageDomain() {
        return $this->container->getParameter('boom_library.boom_image_domain_url');
    }
    ...
    public function getBoomImageUrl($image_path, $w = null, $h = null, $default = '') {
        ...
        $finalUrl = $assetUrl;
        $diffDomain = $this->getBoomImageDomain();
        if ($diffDomain !== null) {
            $finalUrl = $diffDomain . $finalUrl;
        }
        return $finalUrl;
    }
