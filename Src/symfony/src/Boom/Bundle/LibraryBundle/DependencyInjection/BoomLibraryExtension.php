...
class BoomLibraryExtension extends Extension
{
    ...
    public function load(array $configs, ContainerBuilder $container)
    {
        ...
        $container->setParameter('boom_library.profile_image_background', $config['profile_image_background']);
        $container->setParameter('boom_library.profile_image_sizes', $config['profile_image_sizes']);
